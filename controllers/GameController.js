(function (window) {
  class GameController {
    ...
    handleTimeoutSubmission() {
      ...
      this.forceAIResponses();
      this.gameSession.currentRound >= this.totalRounds - 1
        ? this.handleGameOver()
        : this.gameSession.advanceRound() && this.startNewRound();
    }
    ...
    async updateGameStats(finalScores) {
      ...
      // Calculate if player won (player must beat all AI players and ANTE)
      const playerScore =
        finalScores.find(
